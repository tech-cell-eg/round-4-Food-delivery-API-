                    ...
                    <div class="card border-top border-0 border-4 border-primary">
                        <div class="card-body p-5">
                            <div class="card-title d-flex align-items-center">
                                ...
                                <h5 class="mb-0 text-primary">Create New Ingredient</h5>
                            </div>
                            <hr>
                            ...
                            <form action="{{ route('admin.ingredients.store') }}" method="POST" class="row g-3">
                                @csrf
                                ...
                                <div class="col-12">
                                    ...
                                    <select class="form-select @error('type') is-invalid @enderror" 
                                        ...
                                        <option value="basic" {{ old('type') == 'basic' ? 'selected' : '' }}>Basic Ingredient</option>
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="d-flex gap-3">
                                        <button type="submit" class="btn btn-primary px-5">
                                            <i class="bx bxs-save me-1"></i>Create Ingredient
                                        </button>
